base_hash = {:keys => {count = 1}}

base_hash = {:keys => {:railroads => {}}}

base_hash [:railroads][:pieces] = 4

base_hash = {:keys => {:railroads => {:pieces => 4}, {:rent_in_dollars => 4}}}

base_hash = {:railroads => {:pieces => 4}, {:rent_in_dollars => 4}}

base_hash = {:railroads => {:pieces => 4}, {:rent_in_dollars => {:one_piece_owned = 25}, {:two_pieces_owned = 50}, {:three_pieces_owned = 100}, {:four_pieces_owned = 200}}}
